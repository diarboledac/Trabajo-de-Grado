...
El fragmento de c\'odigo mostrado a continuaci\'on aglutina los CSV de \texttt{data/metrics/} para obtener los promedios de latencia y throughput por cantidad de clientes.
